<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="订阅编号" prop="dingyuebianhao">
					<el-input v-model="ruleForm.dingyuebianhao" placeholder="订阅编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dingyuebianhao" label="订阅编号" prop="dingyuebianhao">
					<el-input v-model="ruleForm.dingyuebianhao" placeholder="订阅编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="场地名称" prop="changdimingcheng">
					<el-input v-model="ruleForm.changdimingcheng" placeholder="场地名称" clearable  :readonly="ro.changdimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="场地名称" prop="changdimingcheng">
					<el-input v-model="ruleForm.changdimingcheng" placeholder="场地名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info' && !ro.changditupian" label="场地图片" prop="changditupian">
					<file-upload
						tip="点击上传场地图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-else-if="ruleForm.changditupian" label="场地图片" prop="changditupian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="场地分类" prop="changdifenlei">
					<el-input v-model="ruleForm.changdifenlei" placeholder="场地分类" clearable  :readonly="ro.changdifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="场地分类" prop="changdifenlei">
					<el-input v-model="ruleForm.changdifenlei" placeholder="场地分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="场地位置" prop="changdiweizhi">
					<el-input v-model="ruleForm.changdiweizhi" placeholder="场地位置" clearable  :readonly="ro.changdiweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="场地位置" prop="changdiweizhi">
					<el-input v-model="ruleForm.changdiweizhi" placeholder="场地位置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="订阅时长" prop="dingyueshizhang">
					<el-input v-model="dingyueshizhang" placeholder="订阅时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dingyueshizhang" label="订阅时长" prop="dingyueshizhang">
					<el-input v-model="ruleForm.dingyueshizhang" placeholder="订阅时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="费用" prop="feiyong">
					<el-input-number v-model="ruleForm.feiyong" placeholder="费用" :readonly="ro.feiyong"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="费用" prop="feiyong">
					<el-input v-model="ruleForm.feiyong" placeholder="费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="应付金额" prop="yue">
					<el-input v-model="yue" placeholder="应付金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.yue" label="应付金额" prop="yue">
					<el-input v-model="ruleForm.yue" placeholder="应付金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="订阅时间" prop="dingyueshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.dingyueshijian" 
						type="datetime"
						:readonly="ro.dingyueshijian"
                        :picker-options="dingyueshijianPickerOptions"
						placeholder="订阅时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dingyueshijian" label="订阅时间" prop="dingyueshijian">
					<el-input v-model="ruleForm.dingyueshijian" placeholder="订阅时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="归还时间" prop="guihaishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.guihaishijian" label="归还时间" prop="guihaishijian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="手机号码" prop="shoujihaoma">
					<el-input v-model="ruleForm.shoujihaoma" placeholder="手机号码" clearable  :readonly="ro.shoujihaoma"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="手机号码" prop="shoujihaoma">
					<el-input v-model="ruleForm.shoujihaoma" placeholder="手机号码" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="用户余额" prop="yonghuyue">
					<el-input-number v-model="ruleForm.yonghuyue" placeholder="用户余额" :readonly="ro.yonghuyue"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="用户余额" prop="yonghuyue">
					<el-input v-model="ruleForm.yonghuyue" placeholder="用户余额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="订阅备注" prop="dingyuebeizhu">
					<el-input v-model="ruleForm.dingyuebeizhu" placeholder="订阅备注" clearable  :readonly="ro.dingyuebeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="订阅备注" prop="dingyuebeizhu">
					<el-input v-model="ruleForm.dingyuebeizhu" placeholder="订阅备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="下单时间" prop="xiadanshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.xiadanshijian" label="下单时间" prop="xiadanshijian">
...
export default {
	...
	if(this.ruleForm.changditupian!=null) {
      ...
      if(parseFloat(this.ruleForm.yue)>parseFloat(this.ruleForm.yonghuyue)){
