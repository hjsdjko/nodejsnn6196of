<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="购买编号" prop="goumaibianhao">
					<el-input v-model="ruleForm.goumaibianhao" placeholder="购买编号" clearable  :readonly="ro.goumaibianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="购买编号" prop="goumaibianhao">
					<el-input v-model="ruleForm.goumaibianhao" placeholder="购买编号" readonly></el-input>
				</el-form-item>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `goumaikeshi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									...
									this.$message({
										...
										onClose: () => {
											...
											this.parent.goumaikeshiCrossAddOrUpdateFlag = false;
											this.parent.search();
