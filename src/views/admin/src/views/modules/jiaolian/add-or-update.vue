	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="执教年数" prop="zhijiaonianshu">
					<el-input v-model.number="ruleForm.zhijiaonianshu" placeholder="执教年数" clearable  :readonly="ro.zhijiaonianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="执教年数" prop="zhijiaonianshu">
					<el-input v-model="ruleForm.zhijiaonianshu" placeholder="执教年数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="擅长领域" prop="shanzhanglingyu">
					<el-input v-model="ruleForm.shanzhanglingyu" placeholder="擅长领域" clearable  :readonly="ro.shanzhanglingyu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="擅长领域" prop="shanzhanglingyu">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				zhijiaonianshu: [
					{ required: true, message: '执教年数不能为空', trigger: 'blur' },
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhijiaonianshu'){
							this.ruleForm.zhijiaonianshu = obj[o];
							this.ro.zhijiaonianshu = true;
							continue;
						}
