<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="登记编号" prop="dengjibianhao">
					<el-input v-model="ruleForm.dengjibianhao" placeholder="登记编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dengjibianhao" label="登记编号" prop="dengjibianhao">
					<el-input v-model="ruleForm.dengjibianhao" placeholder="登记编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="上课地点" prop="shangkedidian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="收款课时" prop="keshi">
					<el-input v-model.number="ruleForm.keshi" placeholder="收款课时" clearable  :readonly="ro.keshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="收款课时" prop="keshi">
					<el-input v-model="ruleForm.keshi" placeholder="收款课时" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="授课时间" prop="shoukeshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.shoukeshijian" 
						type="datetime"
						:readonly="ro.shoukeshijian"
						placeholder="授课时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.shoukeshijian" label="授课时间" prop="shoukeshijian">
					<el-input v-model="ruleForm.shoukeshijian" placeholder="授课时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="授课内容" prop="shoukeneirong">
					<el-input
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.shoukeneirong" label="授课内容" prop="shoukeneirong">
					<span :style='{"border":"2px solid #c8c8c8","padding":"0 20px","color":"inherit","background":"none","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"350px","fontWeight":"500"}'>{{ruleForm.shoukeneirong}}</span>
				</el-form-item>
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      ...
	      objcross.keshi = objcross.keshi - this.ruleForm.keshi
	      if(objcross.keshi<0){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `shoukexinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.shoukexinxiCrossAddOrUpdateFlag = false;
											this.parent.search();
