...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="场地分类" prop="changdifenlei">
            <el-select v-model="ruleForm.changdifenlei" placeholder="请选择场地分类" :disabled=" false  ||ro.changdifenlei" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="场地状态" prop="changdizhuangtai">
            <el-select v-model="ruleForm.changdizhuangtai" placeholder="请选择场地状态" :disabled=" false  ||ro.changdizhuangtai" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="费用/小时" prop="feiyong">
			<el-input-number v-model="ruleForm.feiyong" placeholder="费用/小时" :readonly="ro.feiyong"></el-input-number>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="场地设施" prop="changdisheshi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="场地设施"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="场地详情" prop="changdixiangqing">
            <editor 
  ...
  export default {
    data() {
      ...
      return {
        ...
        rules: {
          ...
          changdifenlei: [
            { required: true, message: '场地分类不能为空', trigger: 'blur' },
          ],
          changditupian: [
          ],
          changdiweizhi: [
          ...
          changdizhuangtai: [
            { required: true, message: '场地状态不能为空', trigger: 'blur' },
          ],
          feiyong: [
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/changdifenlei/changdifenlei', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.changdifenleiOptions = res.data.data;
          }
        });
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('changdixinxi/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`changdixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
